...
class ThreeColumnTest extends KernelTestBase {
   ...
   * The layout instance.
   *
   * @var \Drupal\stanford_layout_paragraphs\Layouts\ThreeColumn
   */
  protected $layout;
  ...
  protected function setUp(): void {
    ...
    $configuration = [];
    $plugin_id = 'three_column';
    $plugin_definition = [
      'label' => 'Three Column',
      'category' => 'Test',
      'template' => 'templates/three-column',
      'regions' => [
        'first' => ['label' => 'First'],
        'second' => ['label' => 'Second'],
        'third' => ['label' => 'Third'],
    ...
    $this->layout = new ThreeColumn($configuration, $plugin_id, $plugin_definition);
  }
  ...
  public function testBuildConfigurationFormWithExistingConfig(): void {
    ...
    $layout = new ThreeColumn($configuration, $plugin_id, $plugin_definition);
    ...
    $this->assertEquals('#aabbcc', $result['bg_color']['#default_value']);
  ...
  public function testSubmitConfigurationFormVerticalDividersCast(): void {
    ...
    $form_state->setValue('bottom_padding', NULL);
    $form_state->setValue('bottom_margin', NULL);
    $form_state->setValue('vertical_dividers', 'yes');
  ...
  /**
   * Test buildConfigurationForm without vertical_dividers in config.
   *
   * // Covers: buildConfigurationForm
   */
  public function testBuildConfigurationFormNoVerticalDividers(): void {
    $configuration = [
      'bg_color' => 'ffffff',
    ];
    $plugin_id = 'three_column';
    ...
    $this->assertFalse($result['vertical_dividers']['#default_value']);
  }
