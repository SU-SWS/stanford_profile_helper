...
class HeroPatternBehavior extends ParagraphsBehaviorBase {
  ...
  public function submitBehaviorForm(ParagraphInterface $paragraph, array &$form, FormStateInterface $form_state) {
    ...
    if (isset($values['overlay_color_wrapper'])) {
      $values['overlay_color'] = $values['overlay_color_wrapper']['overlay_color'];
      unset($values['overlay_color_wrapper']);
      $form_state->setValues($values);
    }
    parent::submitBehaviorForm($paragraph, $form, $form_state); // TODO: Change the autogenerated stub
  }
