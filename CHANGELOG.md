...
- Added missing event schedule SDC.

11.0.4
--------------------------------------------------------------------------------
_Release Date: 2026-09-01_
- Adjusted lockup, footer, and brand bar to support other themes
...
- Updated service override for UI Patterns update.

11.0.1
--------------------------------------------------------------------------------
_Release Date: 2026-08-27_
- Fixed error with incomplete library definition
