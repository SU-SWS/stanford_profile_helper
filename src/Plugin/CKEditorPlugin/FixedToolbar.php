...
namespace Drupal\stanford_profile_helper\Plugin\CKEditorPlugin;
...
class FixedToolbar extends CKEditorPluginBase implements CKEditorPluginContextualInterface {
  ...
  public function getFile() {
    return drupal_get_path('module', 'stanford_profile_helper') . '/js/plugins/fixed_toolbar/plugin.js';
  }
